...
while ($row = mysqli_fetch_array($sql)) {
  ...
  $discharge = '<a class="btn btn-primary"  class="btn btn-primary" href="bill.php?admissionId='. $row['unqId'] .'">Discharge</a>';
  $getReport = '<a class="btn btn-primary"  class="btn btn-primary" href="patient_discharge.php?admissionId='. $row['unqId'] .'">Get Report</a>';
