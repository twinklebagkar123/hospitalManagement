    ...
    <div class="container-fluid container-fullw bg-white">
        <div class="row">
            <div class="col-sm-12">
                ...
                $admissionQuery = "SELECT assignedDate,labTestName,admissionID,labTestStatus,recordID,performedTestID FROM labTestRecord as table1 INNER JOIN laboratoryTestList as table2 ON table1.performedTestID = table2.labFormID where date(table1.assignedDate) between '$fromdate' and '$todate' ORDER BY `table1`.`recordID` DESC";
