...
<table class="table table-hover" id="sample-table-1">
	...
	<tbody>
		<?php
		$query = "select tblpatient.PatientName as fname,appointment.*  from appointment join tblpatient on tblpatient.ID=appointment.userId where appointment.doctorId='" . $id . "' AND appointment.appointmentDate BETWEEN '$fromDate' AND '$toDate'";
		//print_r($query);
